                        ...
                        <div className='rentals-content'>
                            {Array.isArray(allRentalCars) ? allRentalCars.map((car) => (
                                <RentalsCard
                                    key={car._id}
                                    car={car}
                                    clickShowCar={handleShowSelectedCar}
                                    selectedCar={handleSelectedCar}
                                />
                            )) : null}
                        </div>
                    </>}  
            ...
            <Dialog disableEscapeKeyDown={true} onBackdropClick={true} open={open} onClose={handleClose} fullWidth={true}>
                ...
                <DialogContent style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <form className='card-form'>
                        <CustomTextField label={"Make"} size={"small"} onChange={e => setMake(e.target.value)} value={make} labelMargin={-7} fullWidth={true} height={27} margin={'dense'} />
                        <CustomTextField label={"Model"} size={"small"} onChange={e => setModel(e.target.value)} value={model} labelMargin={-7} fullWidth={true} height={27} margin={'dense'} />
                        <CustomTextField label={"Number Plate"} size={"small"} onChange={e => setNumberPlate(e.target.value)} value={numberPlate} labelMargin={-7} fullWidth={true} height={27} margin={'dense'} />
                    </form>
